...
// use alternative set of validation layers
            ...
            extension_names.put(memASCII(VK_KHR_SURFACE_EXTENSION_NAME));
            extension_names.put(memASCII(VK_KHR_WIN32_SURFACE_EXTENSION_NAME));
...
// Two stages: vs and fs
            ...
            shaderStages.get(1)
                    ...
                    .module(frag_shader_module = demo_prepare_shader_module(HelloVulkanShader.createFragmentShader()))
                    .pName(main);
